...
public class AssertionBuilderFactoryImpl implements AssertionBuilderFactory {
	...
	private static final LoggerWrapper LOGGER = LoggerWrapperFactory.discoverLogger(AssertionBuilderFactoryImpl.class);
    ...
    public AssertionBuilder<?> getDefaultBuilder() {
    	return defaultBuilder;
    }
}
