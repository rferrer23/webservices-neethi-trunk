...
package org.apache.neethi.service.impl;
...
import org.apache.neethi.exception.PolicyException;
...
public class PolicyBuilder {
    ...
    public Policy getPolicy(InputStream inputStream) {
        try {
            ...
            throw new PolicyException("Could not load policy.", ex); 
        }
    }
    ...
    public PolicyReference getPolicyReference(InputStream inputStream) {
        try {
            ...
            throw new PolicyException("Could not load policy reference.", ex); 
        }
    }
    ...
    private PolicyOperator processOperationElement(Object operationElement,
        ...
        if (Constants.TYPE_POLICY == operator.getPolicyType()) {
        ...
        for (Iterator<?> iterator = factory.getConverterRegistry().getChildElements(operationElement); 
            ...
            processElement(operator, childElement, qn);
        }
        return operator;
    }

	private void processElement(PolicyOperator operator, Object childElement, QName qn) {
