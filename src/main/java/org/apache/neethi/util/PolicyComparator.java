...
public final class PolicyComparator {
	private static final LoggerWrapper LOGGER = LoggerWrapperFactory.discoverLogger(PolicyComparator.class);
    ...
    public static boolean compare(Policy arg1, Policy arg2) {
        ...
        if(!checkName(arg1, arg2) || !checkNamespaces(arg1, arg2) || !checkIdAtt(arg1, arg2)) {
        	return false;
        }       
        return compare(arg1.getPolicyComponents(), arg2.getPolicyComponents());
    }

	private static boolean checkNamespaces(Policy arg1, Policy arg2) {
		// check the namespaces
        return !(arg1.getNamespace() != null
            && !arg1.getNamespace().equals(arg2.getNamespace()));

	}

	private static boolean checkName(Policy arg1, Policy arg2) {
	...
	private static boolean checkIdAtt(Policy arg1, Policy arg2) {
    ...
    public static boolean compare(PolicyComponent arg1, PolicyComponent arg2) {
        ...
        if (arg1 instanceof Policy) {
        	...
        	LOGGER.info("should I throw an exception ..");
        }
