...
package org.apache.neethi.policy;
...
import org.apache.neethi.service.PolicyRegistry;
...
public class Policy extends All {
    ...
    public void serialize(XMLStreamWriter writer) throws XMLStreamException {
        ...
        writeNS = serializeAtt(writer, nspace, prefix2ns, writeNS);
        ...
        for (Entry<String, String> pfx :prefix2ns.entrySet()) {
            writer.writeNamespace(pfx.getKey(), pfx.getValue());
        }
	...
	private boolean serializeAtt(XMLStreamWriter writer, String nspace, Map<String, String> prefix2ns, boolean writeNS)
		...
		for (Map.Entry<QName, String> ents : attributes.entrySet()) {
            ...
            if (namespaceURI != null && XMLConstants.XMLNS_ATTRIBUTE_NS_URI.equals(namespaceURI)) {
                ...
                writeAtt(writer, prefix2ns, key, namespaceURI, localName, ents);
	...
	private void writeAtt(XMLStreamWriter writer, Map<String, String> prefix2ns, QName key, String namespaceURI,
			String localName, Map.Entry<QName, String> ents) throws XMLStreamException {
		String prefix;
    ...
    private class PolicyIterator implements Iterator<List<Assertion>> {
        ...
        public List<Assertion> next() {
            ...
            List<Assertion> asserts = new ArrayList<>(pcs.size());
